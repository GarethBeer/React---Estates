...
Clone down the React Boilerplate

Install dependencies - using npm install

Open project using code . in the terminal.

Start your project using npm start in the terminal and navigate to it in the browser.
